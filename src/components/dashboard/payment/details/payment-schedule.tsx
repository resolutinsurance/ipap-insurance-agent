...
const PaymentScheduleDetails = ({
  ...
  const exclude: (keyof PaymentSchedule)[] = ["user", "user_agent", "insuranceCompany"];
  ...
  const handlePayNextInstallment = () => {
    ...
    const isBundle = record.quoteType === "Bundle" || !!record.assignedBundleName;
          ...
          <div className="space-y-5">
            <div>
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-semibold">Payment Schedule Details</h3>
                <div className="flex gap-2">
                  {(() => {
                    ...
                    return hasPartPayment || hasActiveLoan ? (
                      <Button onClick={handlePayNextInstallment} variant="default">
          ...
          {record.insuranceCompany && (
            <>
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-10">
                  {prepareObjectFields(
                    record.insuranceCompany as unknown as Record<string, unknown>,
