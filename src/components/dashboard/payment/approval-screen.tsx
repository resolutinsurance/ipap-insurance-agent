...
const ApprovalScreen = ({
  ...
  return (
    <>
      <div className="flex flex-col items-center space-y-6 md:p-10 w-full md:max-w-2xl mx-auto">
        <Image
        ...
        <div className="text-center space-y-2">
          <h1 className="font-bold text-2xl text-gray-900">Approval Pending</h1>
          <p className="text-muted-foreground">
            Your payment is currently under review. Please check back later for updates.
          </p>
        </div>
        ...
        <div className="w-full flex flex-col sm:flex-row gap-5 justify-center items-center">
          ...
          >
            {loading || verifyPayment.isPending ? "Verifying..." : "I have Paid"}
          </Button>
        </div>
      </div>
