      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500">
            You&apos;re already verified for this session. If the number is
            incorrect, you can update it and redo verification.
          </p>
        </div>
        ...
        <VerificationResult
          ...
          handleNext={() => {
            ...
            if (isVerificationSuccessful === true) {
              const ghanaCardResponse =
                verificationFlow.ghanaCardResponse ?? null
              onSuccess(
                ghanaCardResponse,
