...
export const ActiveProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <div
      className="cursor-pointer border-b py-4 last:border-b-0 hover:bg-slate-50"
        ...
        <div className="flex flex-col items-end justify-end gap-2">
          <div className="text-muted-foreground text-right text-sm">
            ...
            {productInfo.agent && typeof productInfo.agent === 'object' && (
              <p>
                Agent:{' '}
                {typeof (productInfo.agent as Record<string, unknown>)[
                  'name'
                ] === 'string'
                  ? ((productInfo.agent as Record<string, unknown>)[
                      'name'
                    ] as string)
                  : 'N/A'}
              </p>
