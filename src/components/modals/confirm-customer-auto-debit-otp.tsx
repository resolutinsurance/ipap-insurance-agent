...
import { useAutoDebitOTP, usePremiumFinancingById } from "@/hooks/use-premium-financing";
...
const ConfirmCustomerAutoDebitOTP = ({
  ...
  const isOtpComplete = otpValues.every((v) => v !== "") && otpValues.length === length;
  const isLoading = confirmAutoDebitOTP.isPending || getPremiumFinancingById.isLoading;
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col items-center gap-4 py-4">
          {isFetchingData ? (
            ...
            <>
              <OTPInput value={otpValues} onChange={handleOtpChange} length={length} />
